...
- [Sidekiq reference implementation](https://github.com/mailexam/Sidekiq) — background mail via Sidekiq worker
- [Celery reference implementation](https://github.com/mailexam/Celery) — background mail in Python
